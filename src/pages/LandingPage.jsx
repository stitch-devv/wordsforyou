...
const styles = {
  container: { maxWidth: '750px', margin: '0 auto', padding: '60px 20px', textAlign: 'center' },
  hero: { padding: '40px 0' },
  ...
  section: { marginTop: '60px', background: '#FAF6EF', padding: '30px', borderRadius: '16px', border: '1px solid #EAE3D9' }
};